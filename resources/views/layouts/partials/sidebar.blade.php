<nav id="sidebar" class="d-md-block d-none">
    ...
    <ul class="nav flex-column mt-2">
        ...
        <li class="nav-item"><a href="{{ route('transaksi.index') }}" class="nav-link"><i class="fas fa-exchange-alt me-2"></i> Transaksi</a></li>
        <li class="nav-item mt-5"><a href="#" class="nav-link text-danger"><i class="fas fa-sign-out-alt me-2"></i> Logout</a></li>
    </ul>
</nav>